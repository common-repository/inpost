...
{
	// Remove the shipment address and fill it instead with the InPost
	// locker text. I.e. make it obvious that the parcel is going to an
	// InPost locker.
	if (jQuery('#inpost_shipment').val() == '1')
	{
		jQuery('#shipping_address_1').val('InPost Locker');
		jQuery('#shipping_city').val('InPost Locker');
		jQuery('#shipping_postcode').val('IN9 0ST');
...
{
	// Leave the shipping method field checked in case the user actually
	// set it not us.
